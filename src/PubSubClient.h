...
Modifications to the original class by tschaban: https://github.com/tschaban
 - removing unused code for AFE Firmware
 - changing the concept from callback to immediate processing of the upcoming
message
...
#define MQTT_MAX_PACKET_SIZE 762
#endif
